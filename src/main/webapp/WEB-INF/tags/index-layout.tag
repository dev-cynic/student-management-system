...
<head>
    ...
    <title>CEMC | ${title.toUpperCase()}</title>
</head>
<body>
    <div class="vh100 d-flex">
        <div class="heading d-flex flex-column align-items-center justify-content-center">
            <svg class="headIcon" xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" class="bi bi-journal" viewBox="0 0 16 16">
